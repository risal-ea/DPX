...
const Post = () => {
  ...
  const { addPost, isLoading: addingPostLoading, fileURL, setFile } = useAddPost();
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center items-center">
        {/* Title */}
        <div className="text-3xl text-orange-600 font-semibold tracking-wider">New Post</div>
      </div>
      ...
      <div className="w-full flex flex-col justify-center items-center gap-4">
        ...
        <div className="w-full relative">
          <textarea
            ...
            rows="1"
            className={`${
              captionLength !== 0 ? "text-orange-600 placeholder:text-orange-600" : null
            } ${
              errors.caption
          ...
          <p className="absolute top-0 right-0 text-neutral-400 font-semibold">
            {captionLength === 0 ? <span>30</span> : <span>{captionValidate.maxLength.value - captionLength}</span>}
          </p>
          {errors.caption && captionLength === 0 && (
